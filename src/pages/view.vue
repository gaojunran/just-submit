...
import { ChevronRight, Download, File, RefreshCcw } from 'lucide-vue-next'
...
<template>
  <div class="w-80">
    <h1 class="text-left text-2xl font-bold mb-6">
      已提交的作业 📚
    </h1>
    <div v-for="file in files" :key="file.key" class="border-2 border-white/30 hover:border-white transition duration-300 min-h-20 rounded-lg font-mono flex gap-4 items-center px-4 py-4 mt-4">
    ...
    <div class="text-left text-white/50 mt-4 text-sm">
      重新提交将覆盖已提交的作业，请谨慎操作。
    </div>
