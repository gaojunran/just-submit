...
import { File, Loader2, Plus, Upload, X } from 'lucide-vue-next'
...
<template>
  <div class="w-80">
    ...
    <div
      ...
      class="mt-2 border-2 border-white/30 min-h-20 rounded-lg font-mono flex gap-4 items-center px-4 py-4 hover:border-white transition duration-300"
    >
